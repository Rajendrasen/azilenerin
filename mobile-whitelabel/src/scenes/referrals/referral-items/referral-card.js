...
class ReferralCard extends React.PureComponent {
    ...
    componentDidMount() {
        //console.log("props are here >>>>>>>>>>>> Ref card", this.props.referral)
    ...
    render() {
        ...
        if (this.props[referral]) {
            ...
            //console.log("props data", this.props.referral)
            ...
            return (
                            ...
                            <View style={{ width: '100%', flexDirection: 'row' }}>
                                ...
                                <View style={{ flex: 1, alignItems: 'flex-end' }}>
                                    <Text
                                        ...
                                        {referralDate
                                            ?
                                            moment(referralDate).local().format('M/DD/YYYY') :
                                            moment(referralDate).local().format('M/DD/YYYY')
                                        }
                                    </Text>
                                </View>
              ...
              <View style={{ flex: 0.9 }}></View>
                    ...
                    <View
                        ...
                        <Text style={{ color: COLORS.grayMedium, fontSize: 13 }}>
