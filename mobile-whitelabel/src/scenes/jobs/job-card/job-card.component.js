...
class JobCard extends React.PureComponent {
    ...
    getCurrentTieredBonus(job) {
        ...
        if (
            ...
            // console.log(">>> complete", JSON.parse(JSON.stringify(campaignTieredBonus)));
            let obj = JSON.parse(campaignTieredBonus)
            //  console.log(">>> complete", obj.tiers);
    ...
    checkIsAlreadyReferredToJob1 = () => {
        ...
        console.log("isAlreadyReferredToJob", isAlreadyReferredToJob)
    ...
    handleCardClick = (job, selfReferralValue, currentUser, onCreateReferral) => {
        console.log("handleCardClick Job",job)
        console.log("handleCardClick selfReferralValue",selfReferralValue)
        console.log("handleCardClick currentUser",selfReferralValue)
        console.log("handleCardClick onCreateReferral",onCreateReferral)
    ...
    handleImInterested = () => {
        ...
        if (
            this.props.currentUser1.company.allowSelfReferralsInternalLink && this.state.job.internalJobLink) {
            console.log("Here It is 1")
            this.setState({ interestedInternalLink: true }, () => this.Interested());
    ...
    render() {
        if (this.state.job) {
            ...
            //  console.log("ref bonus", referralBonus);
            ...
            if (typeof referralBonus === 'string') {
                ...
                // console.log("it is string", referralBonus);
                        ...
                        <View style={styles.buttonRow}>
                            ...
                            {showIAmIntereseted && (
                                <TouchableOpacity
                                    ...
                                    onPress={() => this.handleImInterested()}>
