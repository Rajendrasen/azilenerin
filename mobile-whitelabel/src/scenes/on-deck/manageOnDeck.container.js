...
import ManageOnDeckComponent from './manageOnDeck.component';
...
const ManageOnDeckContainer = compose(withListDepartment)(ManageOnDeckComponent);

export const ManageOnDeck = connect(
  mapStateToProps,
  mapDispatchToProps
)(ManageOnDeckContainer);
